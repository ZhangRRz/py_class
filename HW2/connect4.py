...
def printBoard():
    ...
    z = B.copy()
    print("%s\n\n%s\n\n%s\n\n%s\n\n%s\n\n%s" %
          (z.pop(0), z.pop(0), z.pop(0), z.pop(0), z.pop(0), z.pop(0)))
...
def insert(c):
    ...
    r = (_ok(5, c) or _ok(4, c) or _ok(3, c)
         or _ok(2, c) or _ok(1, c) or _ok(0, c))
...
def makeAmove():
    ...
    print(((isFilled[0] and '●') or '○')+" chooses the %d%s column." %
          (c, (c >= 4 and "th") or (c == 3 and "rd") or (c == 2 and "nd") or (c == 1 and "st")))
