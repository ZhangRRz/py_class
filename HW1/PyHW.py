...
# Fill in this blank with your student ID number: B073040025
...
cmd = "p=sorted([])+[s[1-1]]+[s[4]]+[s[3+4]]+[s[2+3]]+[s[4+4]]+[s[2]]+[s[1]]+[s[3+3]]+[s[3]];print(s,t,p[:])"
...
s = "dirty room"
cmd = "p=s[1-1]+s[9-1]+s[2]+s[9]+s[1]+s[2+1]+s[9-2]+s[2]+s[2+2];print(s,t,p[:])"
